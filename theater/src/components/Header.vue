  ...
  <header class="header" id="header">
    <div class="header__content header__content--navbar">
      ...
      <div class="header__logo">
        <RouterLink to="/Home"><img class="logo logo--size" id="logoImage" src="../assets/images/elements/logo_negro.png"/></RouterLink>
      </div>
      <nav class="menu">
        <ul>
          <li>
          ...
          <li>
            ...
            <RouterLink to="/Shows"><a>ENTRADAS</a></RouterLink>
          </li>
        </ul>
      </nav>
