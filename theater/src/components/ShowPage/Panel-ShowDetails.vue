...
<template>
    ...
    <div v-if="showData" class="details-show" id="container-details">
        <div class="details-show__item">
            ...
            <p class="details-show__item-title"><strong>{{ $t("Show.showDetails1") }}</strong></p>
        ...
        <div class="details-show__item">
            ...
            <p class="details-show__item-title"><strong>{{ $t("Show.showDetails2") }}</strong></p>
        ...
        <div class="details-show__item">
            ...
            <p class="details-show__item-title"><strong>{{ $t("Show.showDetails3") }}</strong></p>
        ...
        <div class="details-show__item">
            ...
            <p class="details-show__item-title"><strong>{{ $t("Show.showDetails4") }}</strong></p>
            <p>{{ $t("Show.age") }} <span id="details-show__age">{{ showData.age }}</span> {{ $t("Show.years") }}</p>
        </div>
        <div class="details-show__item">
            ...
            <p class="details-show__item-title"><strong>{{ $t("Show.showDetails5") }}</strong></p>
        ...
        <div class="details-show__item">
            ...
            <p class="details-show__item-title"><strong>{{ $t("Show.showDetails6") }}</strong></p>
        ...
        <div class="details-show__item details-show__item--link" id="button-overview" @click="sheet = !sheet">
            ...
            <p class="details-show__item-title"><strong>{{ $t("Show.showDetails7") }}</strong></p>
            <p>{{ $t("Show.buttonOverview") }}</p>
        </div>
